...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "connection.pb.users_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:

    DESCRIPTOR._options = None
    _AUTHORIZATIONREQUEST._serialized_start = 33  # type: ignore
    _AUTHORIZATIONREQUEST._serialized_end = 70  # type: ignore
    _PERMISSIONREQUEST._serialized_start = 72  # type: ignore
    _PERMISSIONREQUEST._serialized_end = 138  # type: ignore
    _AUTHORIZATIONRESPONSE._serialized_start = 140  # type: ignore
    _AUTHORIZATIONRESPONSE._serialized_end = 210  # type: ignore
    _USERS._serialized_start = 213  # type: ignore
    _USERS._serialized_end = 449  # type: ignore
