    ...
    return (
        <div className="content-center grid rounded-md bg-white py-2 md:col-span-1 col-span-2">
            ...
            <div className="text-center">
                ...
                <div>
                    <button onClick={createTeam} className="bg-indigo-700 py-[0.5em] w-[15em] rounded-md text-white mt-2 hover:bg-indigo-600">
                        Создать команду
                    </button>
                </div>
                <div>
                    <button onClick={joinTeam} className="bg-indigo-700 py-[0.5em] w-[15em] rounded-md text-white mt-2 hover:bg-indigo-600">
                        Присоединиться
                    </button>
                </div>
            </div>) : (<div className="text-center">
            <h1 className="text-lg text-gray-600 mb-2">Текущее задание отсутвует!</h1>
            {isProccessingExist && (<div>
